...
def build_initial_embedding_matrix(vocab_dict, embedding_dim):
  initial_embeddings = np.random.uniform(-0.25, 0.25, ((vocab_dict), embedding_dim)).astype("float32")
#  initial_embeddings = np.random.uniform(-0.25, 0.25, (vocab_dict+1, embedding_dim)).astype("float32")
