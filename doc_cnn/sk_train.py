...
# Training parameters
tf.flags.DEFINE_integer("batch_size", 52, "Batch Size (default: 64)")
#tf.flags.DEFINE_integer("batch_size", 8196, "Batch Size (default: 64)")
#tf.flags.DEFINE_integer("num_epochs",1300, "Number of training epochs (default: 200)")
tf.flags.DEFINE_integer("num_epochs",1100, "Number of training epochs (default: 200)")
