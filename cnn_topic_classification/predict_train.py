...
q1_word_index_pickle = open(FLAGS.data_dir + '/train_q1_word_index_pickle'+FLAGS.num, 'rb')
q2_word_index_pickle = open(FLAGS.data_dir + '/train_q2_word_index_pickle'+FLAGS.num, 'rb')
...
#        temp_q1 = test_step(x_test_temp) 
        ...
        test_finished_q1 = pd.DataFrame(test_step(x_test2),columns =['a0','a1','a2','a3','a4','a5','a6','a7','a8','a9'])
...
#        test_finished_q1 = pd.DataFrame(test_step(x_test_temp),columns =['train_topic1'])
#        test_finished_q2 = pd.DataFrame(test_step(x_test2),columns =['train_topic2'])
...
#            test_finished.to_csv(f,columns=['topic1'])
        ...
        test_file_name = 'finished/train_topic'+FLAGS.num +'.csv'
