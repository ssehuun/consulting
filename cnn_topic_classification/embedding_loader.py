...
#    k = open('data/test_data_pickle', 'rb')
...
#here
    ...
    q1_word_index_pickle = open('train_q1_word_index_pickle', 'wb')
    ...
    q2_word_index_pickle = open('train_q2_word_index_pickle', 'wb')
...
def write_concat_vec(data_dir):
    word_index_pickle = open('word_index_pickle', 'rb')
    pickling = pickle.load(word_index_pickle)
    x = pickling['word_indices']
    y = pickling['y']
    g = open('glove.6B.300d_pickle', 'rb')
    pickling = pickle.load(g)
